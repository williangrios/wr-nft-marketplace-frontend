    ...
    return (
        <div className='w-[80%] m-auto text-gray-500 flex flex-col gap-5'>
            <div>
                ...
                <p className="">Here, you can set preferred display name, create your profile URL and manage other personal settings</p>
            </div>
            <div className="w-full m-auto mt-8 flex items-center flex-col lg:flex-row lg:justify-start lg:items-start gap-4 lg:gap-8 justify-center">
                <div className="">
                    <div className="cursor-pointer h-36 w-36 m-auto rounded-full" {...getRootProps()}>
                        <input {...getInputProps()}/>
                        <Image src={images.logo} alt='account upload' width={150} height={150} className='rounded-full' objectFit='cover'/>
