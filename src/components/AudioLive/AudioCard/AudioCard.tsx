...
function AudioCard() {
  ...
  return (
    <div
      className={`flex relative flex-col overflow-hidden rounded-2xl hover:shadow-lg transition duration-200 ease-out shadow-xs shadow-black hover:shadow-xs`}
    >
      <div className="">
        <Image
      ...
      <div
        className="flex absolute justify-between gap-2 p-6 items-start "
        onClick={() => playMusic()}
      >
        {play ? (
      ...
      <div className="flex justify-between gap-2 p-2 items-start mt-5">
        ...
        <div
          className="text-white bg-gray-500 max-w-[100px] rounded-full w-[40%] py-2 px-4 flex items-center justify-center gap-3"
