...
function Footer() {
  return (
    <div className="flex flex-col w-[80%] p-2 mt-20 items-center gap-8  m-auto">
      <div className="flex flex-col lg:flex-row gap-6 mt-4 justify-start lg:justify-between ">
        <div className="flex lg:w-[30%] flex-col gap-6 items-center justify-center ">
          ...
          <p className="m-auto lg:mx-6 text-justify text-gray-500">
            Explore an exceptional world of digital art and exclusive treasures.
            Discover masterpieces by skilled creators and immerse yourself in
            the NFT realm. Begin an exciting journey, turning your passion for
            art into limitless discovery.
          </p>
          <Socials />
        </div>
        ...
        <div className="w-[50%] lg:w-[19%] flex flex-col gap-4 mt-4">
          ...
          <div className="flex gap-1 items-center justify-between rounded-full px-4 py-2 bg-gray-700">
            <input
              type="email"
              className="grow text-sm outline-none max-w-[75%] bg-transparent text-white"
