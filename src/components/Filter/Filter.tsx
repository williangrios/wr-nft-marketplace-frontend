    ...
    <div className="flex flex-col w-[80%] m-auto mt-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-between">
        <div className="grid grid-cols-3 lg:grid-cols-5 text-gray-500 text-lg gap-6 ">
          <button
            className="border border-transparent w-[90px] hover:border hover:border-gray-500 rounded-full bg-transparent px-2 py-1"
            onClick={() => {}}
          >
            NFTs
          </button>
        ...
        <div className="flex mt-6 lg:mt-0 justify-center lg:justify-end text-gray-500">
          <div
            className="flex justify-center items-center w-full lg:w-[200px] gap-4 rounded-full bg-transparent border border-gray-500 px-6 py-4 "
            onClick={() => openFilter()}
          >
            <FaFilter />
      ...
      {filter && (
        <div className="grid grid-cols-2 lg:grid-cols-5 pt-10 border-t lg:border-t-transparent mt-10 lg:mt-0 border-t-gray-300 text-gray-500 gap-4">
          ...
          <div className="">
            <div
              className="flex gap-2  items-center justify-center lg:gap-4  border border-gray-500 rounded-full bg-transparent p-4 cursor-pointer"
              onClick={() => openImage()}
            >
              <FaImage />
