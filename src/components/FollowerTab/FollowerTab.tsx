...
function FollowerTab({ TopCreators }: FollowerTabProps) {
  ...
  return (
    <div className="flex flex-col w-[80%] m-auto gap-6 items-center justify-center">
      <div className="flex flex-col gap-4 items-center my-4">
        ...
        <div className="flex flex-col items-center justify-center gap-4 p-4 rounded-full lg:shadow-right-bottom ">
          <div className="flex flex-col lg:flex-row w-full px-4 lg:py-2 justify-center gap-4 lg:gap-10 items-center">
            <button
              className={`p-3 w-[180px] rounded-full flex gap-2 justify-center items-center ${
                popular
      ...
      <div className="flex w-[80%] gap-4 m-auto my-10 justify-center">
        <a
          href=""
          className="px-3 py-2 border border-gray-500 text-gray-500 rounded-full hover:text-white hover:bg-gray-500 shadow-right-bottom"
        >
          Show me more
        </a>
        <a
          href=""
          className="px-3 py-2 text-white bg-gray-500 border border-gray-500 rounded-full hover:border hover:bg-white hover:text-gray-500 shadow-right-bottom"
        >
          Become an author
        </a>
      </div>
